...
bc1 = DirichletBC(V, Constant(0), mf, 7)
bc2 = DirichletBC(V, Constant(0), mf, 8)

bc1 = DirichletBC(V, Constant((0.0, 0.0, 0.0)), mf, 7)
bc2 = DirichletBC(V, Constant((1.0, 1.0, 1.0)), mf, 8)
# no DirichletBC
bcs = []
